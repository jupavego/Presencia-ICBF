...
export const AMBITOS = [
  ...
  },
  {
    ...
    herramientas: [
      ...
      { codigo: 'APTITUD', nombre: 'Aptitudes y habilidades percibidas', desc: 'Capacidades que la persona reconoce en sí misma o que su entorno le reconoce.', estado: 'disponible', componentKey: 'APTITUD', disenoPropio: true, nota: 'Última de las 24 herramientas del módulo — completa la cobertura de las 13 esferas.' },
    ],
  },
  {
    codigo: 'C',
